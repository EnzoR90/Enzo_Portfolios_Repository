...
|How do you think the presentation could be improved?|1                                |Using **more images of people**, even if it is talking about money, it advocates for people’s access to financial services, so it would be nice to see more pictures of them and visual examples of those financial services (like concrete reminders and examples of what are you talking about). The “Historical FI Index of Select South East Asian Nations” graph could be a bit slower and have a bit more time after 2021 to allow the eye to process it and the finger to stop the video.|Same with question 4 answer.|FI **strategies**.|
